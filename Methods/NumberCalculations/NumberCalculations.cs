...
class NumberCalculations
{
    static void Main()
    {
        decimal[] deci = new decimal[] { 6.1m, 3.11111m, 2.543m };
        float[] floa = new float[] { 6.1f, 3.1111f, 2.543f };
        byte[] byt = new byte[] { 6, 3, 2 };
        double[] doub = new double[] { 26.1, 32.11111, 22.543 };
        long[] lon = new long[] { 872323726, 93345365352, 52545434352 };
